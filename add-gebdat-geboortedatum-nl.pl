...
my $file_urllist = 'wikipedia-urllist-add-gebdat-geboortedatum-nl.txt';
my %urllist ;
if (-e $file_urllist) {
...
# 
# https://petscan.wmflabs.org/?maxlinks=&cb_labels_yes_l=1&regexp_filter=&sitelinks_yes=&project=wikipedia&langs_labels_any=&links_to_all=&subpage_filter=either&labels_any=&sortorder=ascending&depth=30&ores_prob_from=&language=nl&show_soft_redirects=both&wikidata_prop_item_use=P569&links_to_any=&min_sitelink_count=&ores_prob_to=&interface_language=en&templates_any=&wpiu=none&wikidata_label_language=&sparql=&outlinks_yes=&before=&ns%5B0%5D=1&manual_list_wiki=&categories=Voetballer+naar+nationaliteit&cb_labels_any_l=1&referrer_name=&min_redlink_count=1&wikidata_item=with&outlinks_any=&smaller=&max_sitelink_count=&negcats=Lijsten&search_max_results=500&output_compatability=catscan&source_combination=&cb_labels_no_l=1&doit=
...
# my %mons = ("Januar"=>'01',"Februar"=>'02',"März"=>'03',"April"=>'04',"Mai"=>'05',"Juni"=>'06',"Juli"=>'07',"August"=>'08',"September"=>'09',"Oktober"=>'10',"November"=>'11',"Dezember"=>'12');
 my %mons = ("januari"=>'01',"februari"=>'02',"maart"=>'03',"april"=>'04',"mei"=>'05',"juni"=>'06',"juli"=>'07',"augustus"=>'08',"september"=>'09',"oktober"=>'10',"november"=>'11',"december"=>'12');
...
while(<IN>)
{
 ...
 $title =~ s/\"//og;
 $QID =~ s/\"//og;
my $sitelink = 'https://nl.wikipedia.org/wiki/'.$title;
...
# $sitelink = 'https://nl.wikipedia.org/wiki/Anton_R%C3%BCesch';
...
# https://nl.wikipedia.org/wiki/Anton_R%C3%BCesch
# | geboortedatum               = [[3 april]] [[1922]]


    if ($result2 =~ /\|(\s*)geboortedatum(\s*)=(\s*)([0-9]{1,2}) ([a-z]+) ([0-9]{4})/i) {
...
my $monat_s = sprintf("%02d",  $mons{$monat} );
