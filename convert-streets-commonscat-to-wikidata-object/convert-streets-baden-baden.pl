...
# https://commons.wikimedia.org/wiki/Category:Streets_in_Baden-Baden

# https://petscan.wmflabs.org/?ns%5B0%5D=1&since_rev0=&wikidata_item=without&interface_language=en&categories=Streets%20in%20Baden-Baden&search_max_results=500&edits%5Bflagged%5D=both&language=commons&project=wikimedia&show_redirects=no&cb_labels_any_l=1&negcats=Wikipedia:L%C3%B6schkandidat%0AWikipedia:Schnelll%C3%B6schen&combination=union&cb_labels_yes_l=1&sortby=title&edits%5Bbots%5D=both&cb_labels_no_l=1&edits%5Banons%5D=both&ns%5B4%5D=1&ns%5B14%5D=1&doit=&al_commands=P131%3AQ1741%0AP17%3AQ40%0AP31%3AQ79007
...
if ($result_count eq 0) {    
   ...
   print "LAST\tLen\t\"$lemma_ohne_zusatz\"\n"; # label de - bezeichnung
    ...
    my $alias = $lemma_ohne_zusatz;
      print "LAST\tAde\t\"".$alias.", Baden-Baden\"\n"; # alias de - alias
      print "LAST\tAen\t\"".$alias.", Baden-Baden\"\n"; # alias de - alias
      print "LAST\tAde\t\"".$alias." (Baden-Baden)\"\n"; # alias de - alias
      print "LAST\tAen\t\"".$alias." (Baden-Baden)\"\n"; # alias de - alias
  
     my $beschreibung = "Straße in Baden-Baden";
     my $beschreibung_en = "street in Baden-Baden, Germany";
     
     if ($lemma_ohne_zusatz =~ /platz/i) {
       $beschreibung = "Platz in Baden-Baden";
       $beschreibung_en = "square in Baden-Baden";
    ...
    print "LAST\tP131\tQ4100\n"; # liegt in der Verwaltungseinheit: Baden-Baden (Q4100)
    print "LAST\tP373\t\"$kat\"\n";   # Commonscat-Property
