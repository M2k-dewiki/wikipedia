...
#  my $URL = 'https://commons.wikimedia.org/w/index.php?title=Special:Contributions&limit='.$limit.'&target='.$username.'&namespace=14&tagfilter=&newOnly='.$newOnly.'&start=&end=';
  ...
  my $URL = 'https://commons.wikimedia.org/w/index.php?title=Special:Contributions&offset=20190126151425&limit=50000&target=Tilman2007&namespace=14&tagfilter=&newOnly=1&start=&end=';
